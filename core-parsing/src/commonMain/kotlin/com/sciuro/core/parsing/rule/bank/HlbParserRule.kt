...
class HlbParserRule(
    ...
    override fun matches(event: RawEvent): Boolean {
        return event.sourcePackageOrAddress == "com.hongleongconnect" ||
               event.title.contains("HLB", ignoreCase = true) ||
               matchesAggregatorForward(event, aggregatorPackages, listOf("HLB".lowercase()))
    }
