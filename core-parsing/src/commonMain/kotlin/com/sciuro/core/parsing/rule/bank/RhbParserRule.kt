...
class RhbParserRule(
    ...
    override fun matches(event: RawEvent): Boolean {
        return event.sourcePackageOrAddress == "com.rhbgroup.rhbmobilebanking" ||
               event.sourcePackageOrAddress == "my.com.rhb.rnow" ||
               event.title.contains("RHB", ignoreCase = true) ||
               matchesAggregatorForward(event, aggregatorPackages, listOf("rhb"))
    }
