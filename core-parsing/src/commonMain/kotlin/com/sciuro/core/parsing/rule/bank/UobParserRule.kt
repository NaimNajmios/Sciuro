...
class UobParserRule(
    ...
    override fun matches(event: RawEvent): Boolean {
        return event.sourcePackageOrAddress == "com.uob.infinite" ||
               event.title.contains("UOB", ignoreCase = true) ||
               matchesAggregatorForward(event, aggregatorPackages, listOf("UOB".lowercase()))
    }
